...
import {DailyOutflowCounterLib} from "./lib/DailyOutflowCounterLib.sol";
...
contract Asterix is DN404, OwnableRoles {
    ...
    function setNameAndSymbol(string calldata name_, string calldata symbol_) public onlyOwnerOrRoles(ADMIN_ROLE) {
